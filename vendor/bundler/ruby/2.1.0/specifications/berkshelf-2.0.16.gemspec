# -*- encoding: utf-8 -*-
# stub: berkshelf 2.0.16 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<ridley>, ["~> 1.7.0"])
      s.add_runtime_dependency(%q<solve>, ["~> 0.8.2"])
      ...
      s.add_dependency(%q<ridley>, ["~> 1.7.0"])
      s.add_dependency(%q<solve>, ["~> 0.8.2"])
